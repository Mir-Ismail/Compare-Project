        ...
        <div style={styles.navContainer}>
          <div style={styles.navLeft}>
            ...
            <div style={styles.navLinks}>
              ...
              <Link to="/home-appliances" style={styles.navLink}>
                Home appliances
              </Link>
              <Link to="/audio-video" style={styles.navLink}>
                Audio & video
              </Link>
              <Link to="/refrigerator" style={styles.navLink}>
                Refrigerator
              </Link>
              ...
              <Link to="/gift-cards" style={styles.navLink}>
                Gift cards
              </Link>
            </div>
          </div>
          ...
          {/* Mobile Menu Toggle */}
          <button style={styles.mobileMenuToggle} onClick={toggleMenu}>
            {isOpen ? <FiX /> : <FiMenu />}
          </button>
        </div>
      </nav>
